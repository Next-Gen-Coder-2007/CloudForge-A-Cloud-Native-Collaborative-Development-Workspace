  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Tab Bar Actions (Auto-Save & Save) */}
        <div className="flex items-center gap-1.5 shrink-0 px-2 relative z-40 overflow-visible">
      ...
      {isMarkdown ? (
        ...
        <>
          {/* Secondary Sub-Bar: Breadcrumbs & Editor Formatting / Tools */}
          <div
            style={{
              backgroundColor: gutterBg,
              borderColor: borderColor,
            }}
            className="h-8 px-3 border-b flex items-center justify-between text-[11px] font-mono shrink-0 relative z-20 overflow-visible"
          >
            {/* Breadcrumb Path */}
            <div className="flex items-center gap-1 truncate max-w-[40%] sm:max-w-[50%] opacity-80">
            ...
            <div className="flex items-center gap-1 shrink-0 overflow-visible">
              ...
              {/* Divider */}
              <div className="h-3.5 w-px bg-neutral-300 dark:bg-neutral-700 mx-1 opacity-60" />
